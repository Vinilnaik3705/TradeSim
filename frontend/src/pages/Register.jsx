...
import { ArrowLeft, Github, Mail, Lock, User, Loader2, AlertCircle, CheckCircle2, Eye, EyeOff } from 'lucide-react';
...
export default function Register() {
    ...
    const handleOAuth = async (fn) => {
        ...
        try {
            ...
            setError(err?.message || 'OAuth sign up failed. This provider may not be enabled.');
        }
    };
    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-4 bg-primary relative overflow-hidden">
            ...
            <GlowOrb className="top-0 right-0 translate-x-1/2 -translate-y-1/2 kx-float" color="rgba(56,189,248,0.15)" size={520} />
            <GlowOrb className="bottom-0 left-0 -translate-x-1/2 translate-y-1/2" color="rgba(34,211,160,0.07)" size={480} />
            ...
            <div className="w-full max-w-md relative z-10">
                ...
                <Reveal y={28} blur>
                    <div className="kx-glass rounded-2xl p-8 shadow-2xl relative overflow-hidden hover:border-accent/30 transition-all duration-500">
                        ...
                        {success && (
                            <div role="status" className="mb-5 flex items-start gap-2.5 rounded-xl border border-success/30 bg-success/10 px-4 py-3 text-sm text-success">
                        ...
                        <form onSubmit={handleEmailSignUp} className="flex flex-col gap-3">
                            <label className="flex flex-col gap-1.5">
                                <span className="text-xs font-semibold uppercase tracking-wider text-text-dim">Name</span>
                        ...
                        <div className="mt-8 pt-6 border-t border-white/5 text-center text-xs">
                            ...
                            <Link to="/login" className="kx-underline text-accent hover:text-sky-300 font-bold transition-colors">
                                Sign in here
                            </Link>
                        </div>
                    </div>
